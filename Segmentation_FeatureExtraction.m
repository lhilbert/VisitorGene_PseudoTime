...
Cropped_ImgCell = cell(1,numFiles);
...
parfor ff = 1:numFiles
    ...
    for nn = 1:numNuclei
        ...
        if OP_comps.NumObjects>0 && Cluster_comps.NumObjects>0
            ...
            Cropped_Img_store{nn} = Cropped_Img_cell;
    ...
    Cropped_ImgCell{ff} = vertcat(Cropped_Img_store{:});
    ...
    OP_displCell{ff} = vertcat(OP_Cluster_disp{:});
...
if numInvalid>0
    ...
    for ff = 1:numInvalid
        ...
        disp('File name:')
        disp(listing(invalidInds(ff)).name)
